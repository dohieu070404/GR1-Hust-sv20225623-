...
const data = [
  ...
  { name: "Đèn ",link:"/ledcontrol", icon: <EmojiObjectsIcon /> },
  { name: "Cây trồng", link: "/RelayControl", icon: <YardOutlinedIcon /> },
  { name: "Hiện diện", link: "/motioncontrol", icon: <SpatialTrackingOutlinedIcon /> },
  {
    name: "Môi Trường ",
    link: "/accontrol",
